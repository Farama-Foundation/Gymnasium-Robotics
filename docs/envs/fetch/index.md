...
The Fetch environments are based on the 7-DoF [Fetch Mobile Manipulator](https://www.robotandchisel.com/assets/papers/Fetch-and-Freight-Workshop-Paper.pdf) arm, with a two-fingered parallel gripper attached to it. The main environment tasks are the following:
