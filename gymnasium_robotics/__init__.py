...
def register_robotics_envs():
    ...
    register(
        id="Reacher-v2",
        entry_point="gymnasium.envs.mujoco.reacher_v2:ReacherEnv",
        max_episode_steps=50,
    ...
    register(
        id="Pusher-v2",
        entry_point="gymnasium.envs.mujoco.pusher_v2:PusherEnv",
        max_episode_steps=100,
    ...
    register(
        ...
        entry_point="gymnasium.envs.mujoco.inverted_pendulum_v2:InvertedPendulumEnv",
        max_episode_steps=1000,
    ...
    register(
        ...
        entry_point="gymnasium.envs.mujoco.inverted_double_pendulum_v2:InvertedDoublePendulumEnv",
        max_episode_steps=1000,
    ...
    register(
        id="HalfCheetah-v2",
        entry_point="gymnasium.envs.mujoco.half_cheetah_v2:HalfCheetahEnv",
        max_episode_steps=1000,
    ...
    register(
        id="Hopper-v2",
        entry_point="gymnasium.envs.mujoco.hopper_v2:HopperEnv",
        max_episode_steps=1000,
    ...
    register(
        id="Swimmer-v2",
        entry_point="gymnasium.envs.mujoco.swimmer_v2:SwimmerEnv",
        max_episode_steps=1000,
    ...
    register(
        id="Walker2d-v2",
        max_episode_steps=1000,
        entry_point="gymnasium.envs.mujoco.walker2d_v2:Walker2dEnv",
    )
    ...
    register(
        id="Ant-v2",
        entry_point="gymnasium.envs.mujoco.ant_v2:AntEnv",
        max_episode_steps=1000,
    ...
    register(
        id="Humanoid-v2",
        entry_point="gymnasium.envs.mujoco.humanoid_v2:HumanoidEnv",
        max_episode_steps=1000,
    )
    ...
    register(
        ...
        entry_point="gymnasium.envs.mujoco.humanoidstandup_v2:HumanoidStandupEnv",
        max_episode_steps=1000,
    )
