...
class AdroitHandRelocateEnv(MujocoEnv, EzPickle):
    ...
    * v2:
        ...
        - Fixed `set_env_state` to preserve the object's world position when restoring states with non-zero object joint translations, and to accept the full output of `get_env_state`.
