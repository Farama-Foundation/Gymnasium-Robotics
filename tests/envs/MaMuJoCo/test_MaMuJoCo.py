...
k_dicts_tasks = [
    ...
    pre_computed_k_dict("coupled_half_cheetah", "1p1", ["[{0: [bfoot, bshin, bthigh, ffoot, fshin, fthigh]}, {0: [bfoot2, bshin2, bthigh2, ffoot2, fshin2, fthigh2]}]", "[{0: [bfoot, bshin, bthigh, ffoot, fshin, fthigh], 1: []}, {0: [bfoot2, bshin2, bthigh2, ffoot2, fshin2, fthigh2], 1: []}]", "[{0: [bfoot, bshin, bthigh, ffoot, fshin, fthigh], 1: [], 2: []}, {0: [bfoot2, bshin2, bthigh2, ffoot2, fshin2, fthigh2], 1: [], 2: []}]"]),
]
# fmt: on
